layui.config({
    ...
    if(window.sessionStorage.getItem('userFace')){
        ...
        $(".userAvatar", window.parent.document).attr('src', ftpip+window.sessionStorage.getItem('userFace'));
    }else{
        $("#userFace").attr("src",webstaticname+"/resouce/html/layuicms2.0/images/face.jpg");
    }
    ...
    if(window.sessionStorage.getItem('userInfo')){
        ...
        //填充省份信息，同时调取市级信息列表
        $.get(webstaticname+"/resouce/html/layuicms2.0/json/address.json", function (addressData) {
