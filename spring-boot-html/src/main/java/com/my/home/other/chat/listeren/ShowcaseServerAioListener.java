 ...
 * 
 */
package com.my.home.other.chat.listeren;
...
public class ShowcaseServerAioListener extends WsServerAioListener {
	...
	public void onBeforeClose(ChannelContext channelContext, Throwable throwable, String remark, boolean isRemove) throws Exception {
		...
		System.out.println(channelContext.getClientNode().toString());
		...
		if (wsSessionContext != null && wsSessionContext.isHandshaked()) {
			...
			Integer uid = Integer.parseInt(channelContext.getAttribute("id").toString());
			user.setUid(uid);
